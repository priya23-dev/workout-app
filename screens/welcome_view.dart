...
import 'package:workout_app/screens/inactive_home_view.dart'; // Import for inactive home view
import 'package:workout_app/utils/user_preferences.dart'; // Import for user preferences
                          ...
                          return GestureDetector(
                            ...
                            child: Padding(
                              ...
                              child: Container(
                                ...
                                width: 195,
                                decoration: BoxDecoration(
                                  color: selectedLevel == levels[index]
                                      ? Color(0xFF40D876)
                                      : Color(0xFF232441),
                        ...
                        GestureDetector(
                          onTap: () async {
                            if (selectedLevel != null) {
                              // Save the selected level to user preferences
                              await UserPreferences.saveUserStatus(
                                  selectedLevel!);

                              // Navigate to the appropriate screen
                              if (selectedLevel == "inactive") {
                                Navigator.push(
                                  context,
                                  MaterialPageRoute(
                                      builder: (context) =>
                              ...
                              ScaffoldMessenger.of(context).showSnackBar(
                                SnackBar(
                                  content: Text(
                                    "Please select a level to proceed.",
